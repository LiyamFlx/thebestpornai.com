...
/**
 * Small WebP variant of a post's custom `cover` image, generated by
 * scripts/gen-blog-thumbs.js (e.g. "foo-hero.jpg" -> "foo-hero-thumb.webp").
 * Card/grid contexts only ever render covers at 166-640px wide, so this
 * avoids shipping the full-res original (used by the post page's own hero
 * banner) just to paint a thumbnail. Falls back to postCoverUrl() for posts
 * without a custom `cover` (video-thumbnail covers are already small).
 */
