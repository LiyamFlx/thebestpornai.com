...
WRITER_LLM_API_KEY=AIza...                  # Gemini API key (or set GEMINI_API_KEY) — free at aistudio.google.com
# WRITER_LLM_MODEL=gemini-2.5-flash                   (default)
